...
- When working with code related tasks; DO NOT put unnecessary/narrating comments on file/func/method/logic/etc. Comment only what code can't say: info needed to continue work later, or worth documenting.
